...
$execute if items entity @s weapon.* #avarice:tool_locks/any_no_bows[minecraft:custom_data~{avarice:{tier:{stat:"$(modifier)"}}}] run attribute @s $(stat) modifier add avarice:$(type)_tier $(tool_value) $(operation)
