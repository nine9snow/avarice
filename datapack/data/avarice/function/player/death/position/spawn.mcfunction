...
execute as @n[type=minecraft:item_display,tag=avarice.death_urn] run data modify entity @s item.components."minecraft:custom_data".items set from storage avarice:macro root.death_items
